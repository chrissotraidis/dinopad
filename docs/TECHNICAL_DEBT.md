...
|---|---|---|
| Root license and third-party notices | The repository has no root license grant or complete assembled notice set. The validated macOS inventories hash 17 direct linked components, 8 selected resources, and all 2,227 compiler dependency paths across 46 ownership roots. The app indexes 39 exact standalone licenses, but 7 inline-primary-notice roots, possible secondary notices, and equivalent iOS graph coverage remain open. | Decide the license for DinoPad-owned work, satisfy GPL source/notice obligations, review/assemble inline and secondary notices, derive iOS coverage, and audit both final products. |
