...
| Incomplete menu | The persistent menu has real touch enable, layout customize/reset, ROM management, and quit-to-home actions, but the plan-listed settings/status hierarchy and diagnostics are absent. | Implement the complete menu tree in `IMPLEMENTATION_PLAN.md` section 3.4. |
