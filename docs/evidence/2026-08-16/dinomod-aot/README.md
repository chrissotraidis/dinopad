...
The pinned DinoMod Enhanced v0.9.3 source built a MIPS-II mod ELF (42,997,184 bytes) with the pinned n64recomp-clang toolchain, RecompModTool packaged the .nrm (mod_syms.bin 201,008 B; mod_binary.bin 42,711,744 B; mod.json 32,425 B; thumb.png), and OfflineModRecomp emitted 6,979,048 bytes of C (920 mod functions, 37 imports, 2,346 reference symbols, 294 replacements, 42 hooks in the symbol file).
